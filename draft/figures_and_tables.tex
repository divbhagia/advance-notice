...
\end{subfigure}
\floatfoot{\textit{Note:} The figure presents data and estimates for the unweighted analytical sample. Panel A presents the exit rate from the data separately for long and short-notice workers. The solid blue line in panel B shows the estimated structural hazard from the Mixed Hazard model, while the dotted black line represents the average exit rate for short and long-notice workers in the data.}
\end{figure}
